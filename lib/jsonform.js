...
jsonform.defaultTemplates = {
  ...
  'array':   jsonform.defaultFieldTemplate('<ul id="<%= elt.id %>" class="_jsonform-array-ul" style="list-style-type:none;"><%= elt.itemshtml %></ul><span class="_jsonform-array-buttons"><a href="#" class="_jsonform-array-addmore">Add more</a> | <a href="#"  class="_jsonform-array-deletelast">Delete last</a></span>') // on the 2nd <a> :  style="display:none;"
};
