...
formNode.prototype.insertArrayItem = function (idx, domElement) {
  ...
  // (re-use former submitted values as a way to recover lost values
  // in case the user accidently suppressed an array item)
  this.children[idx].resetValues();
  this.children[idx].computeInitialValues(this.ownerTree.formDesc.value);
