...
var initializeTabs = function (tabs) {
  ...
  tabs.each(function () {
    ...
    $(this).find('select.nav').each(function () {
      ...
      var targetIdx = $(this).find('option:selected').attr('value');
  ...
  'tabarray': {
    ...
    'onInsert': function (evt, node) {
      ...
      $('> a._jsonform-array-addmore', $nodeid).click(function (evt) {
        var idx = node.children.length;
        if (maxElements>=0) {
          if (idx>maxElements-2) $('> a._jsonform-array-addmore', $nodeid).addClass("disabled");
...
formNode.prototype.computeInitialValues = function (values, ignoreDefaultValues) {
  ...
  if (this.view && this.view.inputfield) {
    ...
    nbChildren = 0;
    if (values) {
      // TODO: this does not work, because the array path is not enough here.
      // Typically, if we are at foo[].bar[] and looking at the number of
      // children in foo[1], the getPreviousNumberOfItems function needs to
      // know that we're interested in "bar" and not in other properties.
      // Problem is that info is kind of hidden because the current view does
      // not really expose it.
