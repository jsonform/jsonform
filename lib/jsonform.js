...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons"'  + '<%= add_remove_hidden %>' + '>' +
    ...
    'onBeforeRender':function(data,node){
      data.add_remove_hidden=''
      if(isSet(node.formElement.hide_add_remove) && node.formElement.hide_add_remove == true){
        data.add_remove_hidden=' style="display:none;" '
      }
    },
    'onInsert': function (evt, node) {
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '</div>' +
      '<span'+ '<%= add_remove_hidden %>' + '>'+
        '<a href="#" class="btn btn-default _jsonform-array-addmore"><i class="glyphicon glyphicon-plus-sign" title="Add new"></i></a> ' +
        '<a href="#" class="btn btn-default _jsonform-array-deleteitem"><i class="glyphicon glyphicon-minus-sign" title="Delete item"></i></a>'
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    ...
    'onBeforeRender': function (data, node) {
      ...
      data.tabs = tabs;
      // mark the add/remove buttons hidden if requested
      data.add_remove_hidden=''
      if(isSet(node.formElement.hide_add_remove) && node.formElement.hide_add_remove == true){
        data.add_remove_hidden = ' style="display:none"; '
      }
