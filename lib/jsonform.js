...
jsonform.elementTypes = {
  ...
  'array': {
    ...
    'onInsert': function (evt, node) {
      ...
      $(node.el).on('click', 'a._jsonform-array-additem', function (evt) {
        evt.preventDefault();
        var idx = $(evt.target).parents('[data-idx]').eq(0).data('idx');
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '</div>' +
      '<a href="#" class="btn _jsonform-array-addmore">Add new</a> ' +
      '<a href="#" class="btn _jsonform-array-deleteitem">Delete selected</a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
