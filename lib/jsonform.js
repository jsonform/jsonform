...
jsonform.elementTypes = {
  ...
  'array': {
    ...
    'onInsert': function (evt, node) {
      ...
      $('#'+node.id+' > span > a._jsonform-array-addmore').click(function (evt) {
        evt.preventDefault();
        evt.stopPropagation();
      ...
      $('#'+node.id+' > span > a._jsonform-array-deletelast').click(function (evt) {
        evt.preventDefault();
        evt.stopPropagation();
  ...
  'tabarray': {
    ...
    'onInsert': function (evt, node) {
      ...
      console.log(node.children[0].children[0],firstArraySchema,maxElements);
      ...
      $('#'+node.id+' > a._jsonform-array-deleteitem').click(function (evt) {
        ...
        if (maxElements>=0 && idx<=maxElements-1) {
          $('#'+node.id+' > a._jsonform-array-addmore').removeClass("disabled");
        }
      });

      $('#'+node.id+' > a._jsonform-array-addmore').click(function (evt) {
        var idx = node.children.length;
        if (maxElements>=0) {
          if (idx>maxElements-2) $('#'+node.id+' > a._jsonform-array-addmore').addClass("disabled");
