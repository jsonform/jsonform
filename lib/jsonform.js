...
formNode.prototype.generate = function () {
  ...
  var childrenhtml = '';
  _.each(this.children, function (child) {
    if (!child.formElement.hidden) childrenhtml += child.generate();
  });
...
formTree.prototype.initialize = function (formDesc) {
  ...
  this.formDesc.form = this.formDesc.form || global.JSONForm.formDefault.form;
