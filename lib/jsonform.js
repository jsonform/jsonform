...
jsonform.elementTypes = {
  'text':{
    'template':'<input class="input-xlarge" type="text" name="<%= elt.name %>" value="<%= escape(elt.value) %>" id="<%= elt.id %>" />',
    'fieldtemplate':true
  },
  'password':{
    'template':'<input class="input-xlarge" type="password" name="<%= elt.name %>" value="<%= escape(elt.value) %>" id="<%= elt.id %>" />',
    'fieldtemplate':true
  },
  'textarea':{
