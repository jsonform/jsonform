...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn _jsonform-array-addmore"><i class="icon-plus-sign"></i></a> ' +
        '<a href="#" class="btn _jsonform-array-deletelast"><i class="icon-minus-sign"></i></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
      if ($('').sortable) {
        ...
        return '<li data-idx="<%= node.childPos %>">' +
          '<span class="draggable"><i class="icon-list"></i></span>' +
          inner +
          '</li>';
      }
      else {
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '<a href="#" class="btn _jsonform-array-addmore"><i class="icon-plus-sign"></i></a> ' +
      '<a href="#" class="btn _jsonform-array-deleteitem"><i class="icon-remove-sign"></i></a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
