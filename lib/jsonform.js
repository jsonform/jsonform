  ...
  'array': {
    ...
    'onInsert': function (evt, node) {
      ...
      if (boundaries.minItems >=0 && curItems < boundaries.minItems) {
        for (var i=0;i<(boundaries.minItems-1) && 
                    ($('> ul > li', $nodeid).length < boundaries.minItems);i++) {
...
formNode.prototype.generate = function () {
  ...
  if (this.ownerTree &&
      ...
      this.ownerTree.formDesc.params.inputSize) {
    data.inputSize = this.ownerTree.formDesc.params.inputSize;
  }
  if (this.formElement &&
      (typeof this.formElement.inputSize !== 'undefined')) {
    data.inputSize = this.formElement.inputSize;
  }
