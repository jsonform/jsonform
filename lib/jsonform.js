...
formNode.prototype.computeInitialValues = function (values, ignoreDefaultValues) {
  ...
  var nbChildren = 1;
  var i = 0;
  var formData = this.ownerTree.formDesc.data || {};
    ...
    if (this.formElement.options) {
      this.options = _.map(this.formElement.options, function (option) {
        if (_.isObject(option) && option.title) {
          return {
            value: option.value,
            title: _.template(option.title, formData, valueTemplateSettings)
          };
        }
        else {
          return option;
  ...
  if (this.view && this.view.inputfield) {
    ...
    if (values) {
      ...
      if (this.schemaElement['default']) {
        if (_.isString(this.schemaElement['default'])) {
          this.value = _.template(
            this.schemaElement['default'],
...
formNode.prototype.enhance = function () {
  ...
  var handlers = null;
  var handler = null;
  var formData = _.clone(this.ownerTree.formDesc.data) || {};
